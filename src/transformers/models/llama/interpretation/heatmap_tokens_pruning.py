...
if __name__ == "__main__":
    ...
    combined_df['ppl'][combined_df['ppl'] > args.max_ppl] = args.max_ppl
    ...
    plt.title(f"PPL Values by Fan-in Index and File. Checkpoint: {args.output}")
    plt.xlabel("Fan-in Index")
    plt.ylabel("File")
    # plt.yscale('log')

    # Save the figure
    output_path = os.path.join(args.output, f"ppl_heatmap.png")
    plt.tight_layout()

    ...
    for i in range(6):
        for j in range(10):
            ...
            result = client.run_job(
                payload={
                    'script': f"bash -c 'cd {workdir} && /workspace-SR004.nfs2/d.tarasov/envs/tokens_pruning/bin/python src/transformers/models/llama/tmp/tokenize_fineweb_edu.py --data_file {data_file}'",
                    'job_desc': f'Tokenize fineweb edu {data_file} #{author_name} #rnd #multimodal @mrsndmn',

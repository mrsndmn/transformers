...
if __name__ == '__main__':
    ...
    for i in range(len(model_1000.model.layers)):
        assert torch.allclose(model_4000.model.layers[i].mlp.gate_proj.weight, model_1000.model.layers[i].mlp.gate_proj.weight)
        assert torch.allclose(model_4000.model.layers[i].mlp.up_proj.weight, model_1000.model.layers[i].mlp.up_proj.weight)
        assert torch.allclose(model_4000.model.layers[i].mlp.down_proj.weight, model_1000.model.layers[i].mlp.down_proj.weight)

        assert torch.allclose(model_4000.model.layers[i].self_attn.q_proj.weight, model_1000.model.layers[i].self_attn.q_proj.weight)

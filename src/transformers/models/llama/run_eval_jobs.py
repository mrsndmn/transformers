...
def eval_hcg_adaptive_pretrain(**kwargs):
    ...
    hcg_experiments = [
        ...
        {
            "pretrained_model": "./adaptive_hcg_slm2_1.7B_fixed_pruning_percent_8_pr_pct20/checkpoint-18743/"
        },
        {
            "pretrained_model": "./adaptive_hcg_slm2_1.7B_fixed_pruning_percent_8_pr_pct30/checkpoint-18743/"
        },
        {
            "pretrained_model": "./adaptive_hcg_slm2_1.7B_fixed_pruning_percent_8_pr_pct40/checkpoint-18743/"
        },
        {
            "pretrained_model": "./adaptive_hcg_slm2_1.7B_fixed_pruning_percent_8_pr_pct60/checkpoint-18743/"
        },
        {
            "pretrained_model": "./adaptive_hcg_slm2_1.7B_fixed_pruning_percent_8_pr_pct80/checkpoint-18743/"
        },
    ]
